...
| 7 | `35024cc` | correções da **rodada 1 do concílio** (4 lentes) + 5 testes novos (14 verdes) | concílio de entrega, rodada 1 | 3/5 |
| 8 | (este) | **rodada 2 do concílio** (2 lentes) + fecho da frente: 12/12 correções verificadas fechadas, 10 achados vivos entregues ao operador | concílio de entrega, rodada 2 — teto | 3/5 · frente encerrada |
